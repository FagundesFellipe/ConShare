...
import br.conshare.client.service.RestService;
...
public class UserServiceImpl implements UserService {
	...
	public Usuario validateUsernameAndPassword(String username, String password) {
		...
		String endpoint = "http://localhost:8085/api/account/login";
		...
		try {
			...
			ResponseEntity<Usuario> responseEntity = restTemplate.exchange(endpoint, HttpMethod.POST, httpEntity, Usuario.class);
